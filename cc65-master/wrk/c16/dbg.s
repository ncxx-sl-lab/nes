...
L03C9:	dey
	...
	sta     _StackAddr
	jmp     L03C3
L03CD:	jsr     _StackHome
	jmp     L03C3
L03D0:	dec     _StackAddr
	jmp     L03C3
L03D5:	inc     _StackAddr
	jmp     L03C3
L055B:	ldx     #$00
	lda     (sp),y
	jmp     incsp2
L03C3:	jsr     _UpdateStack
	jmp     L03BC
...
L040D:	dey
	...
	sta     _CStackAddr+1
	jmp     L0407
L0411:	jsr     _CStackHome
	jmp     L0407
L0414:	lda     _CStackAddr
	sec
	sbc     #$02
	sta     _CStackAddr
	bcs     L0407
...
L0560:	lda     L04D6
	...
	beq     L04E8
	jmp     L0561
L04DF:	jsr     _UpdateAsm
	jmp     L0561
L04E2:	jsr     _UpdateStack
	jmp     L0561
L04E5:	jsr     _UpdateCStack
	jmp     L0561
L04E8:	jsr     _UpdateDump
L0561:	lda     L04D6
	clc
	adc     #$01
	and     #$03
...
L0519:	ldy     #$01
	...
	jsr     _ActivateFrame
	jmp     L0505
L051C:	jsr     _HelpHandler
	jmp     L0505
L0521:	jsr     _SetRTSBreak
	lda     #$01
	ldy     #$00
	sta     (sp),y
	jmp     L05A8
